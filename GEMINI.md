...
{{ numPS }} - liczba godzin zajęć terenowych na studiach stacjonarnych (dane skopiowne z planu studiów)
{{ numPNS }} - liczba godzin zajęć terenowych na studiach niestacjonarnych (dane skopiowne z planu studiów)
...
{{ numPwS }} - liczba godzin pracy własnej studenta na studiach stacjonarnych (dane skopiowne z planu studiów)
{{ numPwNS }} - liczba godzin pracy własnej studenta na studiach niestacjonarnych (dane skopiowne z planu studiów)
